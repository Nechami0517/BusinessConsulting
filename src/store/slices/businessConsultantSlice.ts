...
import type { BusinessConsultantState } from '../../types';

const initialState = {
  consultants: [] as BusinessConsultantState[],
  isLoading: false,
  error: null as string | null,
};

// Async thunks
export const fetchConsultants = createAsyncThunk<BusinessConsultantState[], void>(
...
export const fetchConsultantById = createAsyncThunk<BusinessConsultantState, string>(
...
export const createConsultant = createAsyncThunk<BusinessConsultantState, { name: string; password: string; email: string; role: string }>(
...
export const updateConsultant = createAsyncThunk<BusinessConsultantState, { id: string; data: { name?: string; password?: string; email?: string; role?: string } }>(
