    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {appointments.map((appointment) => {
          ...
          return (
            <div key={appointment.id} className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:shadow-xl transition-all duration-200">
      ...
      {appointments.length === 0 && !isLoading && (
        <div className="text-center py-12">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-gray-600 mb-2">No appointments scheduled yet</p>
            <p className="text-sm text-gray-500">Appointments will appear here when clients book your services</p>
          </div>
        </div>
      )}
